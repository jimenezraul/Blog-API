...
const Navbar = () => {
  ...
  return (
    <div className='z-10 bg-white border-b-2 shadow-md'>
            ...
            {isLogged ? (
              ...
              <>
                <li>
                  <Link
                    to='/login'
                    className='inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-orange-400 hover:bg-orange-500 focus:shadow-outline focus:outline-none'
                  >
                    Log in
                  </Link>
                </li>
